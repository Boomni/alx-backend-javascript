...
describe('calculateNumber', function () {
  ...
  it('should return 5 for 2.4 and 2.6', function () {
    const result = calculateNumber(2.4, 2.6);
    assert.strictEqual(result, 5);
  });

  it('should return -2 for -1.4 and -0.6', function () {
    const result = calculateNumber(-1.4, -0.6);
    assert.strictEqual(result, -2);
  });

  it('should return 6 for 6 and 0', function () {
  ...
  it('should return 21 for 10 and 10.9', function () {
